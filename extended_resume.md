...
__Nike__  
__Task:__ Nike's request was to optimize recommender systems so that it can handle traffic during Black Friday.  
__Role&Results:__ I was a team lead. The task is done: ML&data pipelines have been significantly (twice as fast without loss of quality) optimized. Implemented recommender systems for new regions.  
__Technologies:__ PySpark, Tensorflow, Airflow, Databricks, AWS, Jenkins, MLFlow

__Levi's__  
__Task:__ The task is to predict demand for every shop and product for stock optimization. The project is done.  
__Technologies:__ AWS Athena, Catboost
...
__Technologies:__ Snowflake, Catboost, Airflow
...
__Technologies:__ AWS Kinesis, AWS Lambda, AWS EMR, Airflow, Kubernetes, Elasticsearch, Grafana
...
__Technologies:__ Kubernetes, Docker, Istio, Teamcity, MLFLow
...
__Technologies:__ Tensorflow, TFlite, OpenCV 
